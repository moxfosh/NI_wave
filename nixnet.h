...
#define nxErrFrameWriteTooLarge                         (nxStatus_t)(0xBFF6309F) // -1074384737
...
#define nxErrWrongNumSignalsWritten                     (nxStatus_t)(0xBFF63160) // -1074384544
...
//! The wait did not complete, because it was aborted. This typically occurs
//! when the XNET session is closed while a wait is in progress. Solution: Allow
//! the wait to finish before closing the XNET session.
#define nxErrWaitAborted                                (nxStatus_t)(0xBFF63240) // -1074384320
...
//! You wrote a frame whose payload length is smaller than the minimum payload
//! size allowed. Solution: Never write fewer payload bytes than the minimum
//! allowed size for the session.
#define nxErrFrameWriteTooSmall                         (nxStatus_t)(0xBFF63249) // -1074384311
...
#define nxPropSession_IntfCANPendTxOrder         ((u32)0x00100020) // u32 --rw
